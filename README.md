...
module "template" {
  ...
  chart         = "app" # for local chart
  repository    = "./repository"
  chart_version = "0.1.0"
  values        = "./repository/values.yaml" # for local chart
}
```
...
| <a name="input_app"></a> [app](#input\_app) | an application to deploy | `map(any)` | <pre>{<br>  "chart": null,<br>  "deploy": true,<br>  "name": null,<br>  "path": null,<br>  "repository": null,<br>  "version": null<br>}</pre> | no |
...
| <a name="input_values"></a> [values](#input\_values) | Extra values | `string` | n/a | yes |
